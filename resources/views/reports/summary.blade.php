...
<div class="max-w-7xl mx-auto py-10 px-6 lg:px-8">
    ...
    <form id="filterForm" method="GET" action="{{ route('reports.summary') }}" class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-6 mb-2 flex flex-row gap-6 items-end">
        ...
        <div class="flex flex-col min-w-[120px]">
            ...
            <select name="year" id="year" @if(!optional($selectedCompany)->id) disabled @endif class="px-3 py-2 border border-gray-300 rounded-md focus:ring-teal-500 focus:border-teal-500 bg-white dark:bg-gray-900 dark:border-gray-600 disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed dark:disabled:bg-gray-800 dark:disabled:text-gray-500">
        ...
        @if($monthlyData->count())
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
                    ...
                    <div class="relative overflow-hidden rounded-lg ring-1 ring-gray-200 dark:ring-gray-700">
                        <table class="min-w-full text-sm">
                            ...
                            <thead class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-700/60 text-gray-700 dark:text-gray-200 text-xs uppercase tracking-wide sticky top-0 z-10">
                                <tr>
                                    <th class="px-4 py-2 text-left font-semibold sticky left-0 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-700/60 z-10"></th>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <div id="ganttContainer" class="hidden h-72 overflow-y-auto pr-2 space-y-3">
                        @foreach($monthlyData as $row)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateYearState(focus = false) {
        ...
        yearSelect.disabled = !hasCompany;
        if (!hasCompany) {
